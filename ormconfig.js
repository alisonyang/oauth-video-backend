...
const username = process.env.TYPEORM_USERNAME || 'alisonyang';
const password = process.env.TYPEORM_PASSWORD || '602921';
const host = process.env.TYPEORM_HOST || 'localhost';
const port = parseInt(process.env.TYPEORM_PORT, 10) || 5432;
const database = process.env.TYPEORM_DATABASE || 'alisonyang';
